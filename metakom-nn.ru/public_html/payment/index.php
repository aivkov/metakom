...
$APPLICATION->SetPageProperty("description", "Каталог товаров ООО «Метаком Сервис» - г. Нижний Новгород");
...
$APPLICATION->SetTitle("Оплата и доставка в «Метаком сервис» Нижний Новгород");?>
