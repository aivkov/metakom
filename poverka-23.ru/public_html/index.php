...
$APPLICATION->SetPageProperty("description", "Компания «Метаком-Сервис» занимается поверкой приборов учёта водоснабжения в Краснодаре. Внесение данных в систему «АРШИН»");
$APPLICATION->SetPageProperty("keywords", "Поверка счетчиков воды, Метаком Краснодар");
$APPLICATION->SetPageProperty("title", "Поверка счетчиков воды | Компания Метаком Краснодар");
$APPLICATION->SetTitle("Поверка счетчиков воды, Метаком Краснодар");
