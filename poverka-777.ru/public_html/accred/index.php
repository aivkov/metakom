...
$APPLICATION->SetPageProperty("description", "Метаком Сервис является аккредитованой компанией в области обеспечения единства измерений");
$APPLICATION->SetPageProperty("keywords", "аттестат аккредитации");
$APPLICATION->SetPageProperty("title", "Аттестат аккредитации | Метаком Сервис Москва");
