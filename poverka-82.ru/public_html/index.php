...
$APPLICATION->SetPageProperty("description", "Компания «Метаком-Сервис» занимается поверкой приборов учёта водоснабжения в Крыму. Внесение данных в систему «АРШИН»");
$APPLICATION->SetPageProperty("keywords", "Поверка счётчиков воды, Компания Метаком Крым");
$APPLICATION->SetPageProperty("title", "Поверка счётчиков воды | Компания Метаком Крым");
$APPLICATION->SetTitle("Поверка счётчиков воды | Компания Метаком Крым");
